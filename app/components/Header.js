        ...
        return (
            <header className="bg-white-only header header-md navbar navbar-fixed-top-xs">
                ...
                <div className="navbar-header aside bg-info nav-xs">
                    ...
                    <a className="navbar-brand text-lt" href="index.html">
                        <i className="icon-earphones"></i><img alt="." className="hide" src="images/logo.png" /> <span className="hidden-nav-xs m-l-sm">Musik</span>
                    </a>
                ...
                <ul className="nav navbar-nav hidden-xs">
                    <li>
                        <a className="text-muted" data-toggle="class:nav-xs,nav-xs" href="#nav,.navbar-header">
                            <i className="fa fa-indent text"></i><i className="fa fa-dedent text-active"></i>
                        </a>
                    </li>
                </ul>
                    ...
                    <div className="form-group">
                        <div className="input-group">
                            <span className="input-group-btn">
                                <button className="btn btn-sm bg-white btn-icon rounded" type="submit">
                ...
                <div className="navbar-right">
                    <ul className="nav navbar-nav m-n hidden-xs nav-user user">
                        <li className="hidden-xs">
                            <a className="dropdown-toggle lt" data-toggle="dropdown" href="#">
                                <i className="icon-bell"></i> <span className="badge badge-sm up bg-danger count">2</span>
                            </a>
                            ...
                            <section className="dropdown-menu aside-xl animated fadeInUp">
                                <section className="panel bg-white">
                                    ...
                                    <div className="list-group list-group-alt">
                                        <a className="media list-group-item" href="#">
                                            <span className="pull-left thumb-sm">
                                                <img alt="..." className="img-circle" src="images/a0.png" />
                                             </span>
                                    ...
                                    <div className="panel-footer text-sm">
                                        <a className="pull-right fa fa-cog" href="#" ></a>
                        ...
                        <li className="dropdown">
                            <a className="dropdown-toggle bg clear" data-toggle="dropdown" href="#"><span className=
                            "thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm">
                                <img alt="..." src="images/a0.png" /></span> John.Smith <b className="caret"></b>
                            </a>
